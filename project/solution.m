...
% are shown.
%%
% The results show the PCG with regularisation is the best performing
% algorithm. From the results, the prior preconditioning matrix has a large
% affect on the solution. The total variation method does perform very
% poorly which is probably due to implementation error.